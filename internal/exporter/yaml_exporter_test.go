...
func TestYAMLExporter_Write(t *testing.T) {
...
func TestYAMLExporter_Write_InvalidPath(t *testing.T) {
	exp := NewYAMLExporter()
	err := exp.Write([]*domain.Snippet{{Command: "ls"}}, "/nonexistent/dir/file.yaml")
	assert.Error(t, err)
